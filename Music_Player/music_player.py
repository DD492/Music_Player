...
class Player(tk.Frame):
	...
	def control_widgets(self):
		...
		self.prev = tk.Button(self.controls, image=perv)
...
img = PhotoImage(file=r"D:\git project dinesh\Music player\images\imag.gif")
next_=PhotoImage(file=r"D:\git project dinesh\Music player\images\next.gif")
perv = PhotoImage(file=r"D:\git project dinesh\Music player\images\previous.gif")
play = PhotoImage(file=r"D:\git project dinesh\Music player\images\play.gif")
pause = PhotoImage(file=r"D:\git project dinesh\Music player\images\pause.gif")
